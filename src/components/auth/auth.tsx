  ...
  return (
    <>
      <div className="flex lg:flex-col flex-row w-[60%]   lg:justify-end justify-between lg:items-stretch items-center mb-[24px]">
        ...
        <h2
          className={`${text_size.h2} text-center lg:text-left text-[#FF6D1F] `}
        >
          Login{" "}
        </h2>
      </div>
      <div className="flex flex-col items-start rounded-[32px] border border-[#D4D3D3] bg-[#F5E7C6] gap-6 p-[15px] px-4  md:gap-6 md:p-[15px] md:px-4 lg:w-[580px] lg:p-8 lg:gap-8  w-full">
        {compo}
        <p className={`${text_size.p3} text-center`}>
          By signing up, you agree to{" "}
          <span className="text-[#FF6D1F]">Terms and Conditions</span>,{" "}
          <span className="text-[#FF6D1F]">Privacy Policy</span> &{" "}
          <span className="text-[#FF6D1F]">End User License Agreement</span>
        </p>
      </div>
    </>
  );
